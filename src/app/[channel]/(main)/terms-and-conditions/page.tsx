...
export const metadata: Metadata = {
  ...
  description:
    "Review the terms and conditions that govern the use of the Hashtel Technology website and services.",
  keywords:
    "Hashtel terms, user agreement, conditions of use, electronics e-commerce policies",
  twitter: {
      ...
      <div className="bg-accent py-8 md:px-16 px-4">
        <div className="flex flex-col gap-6 bg-white md:px-8 px-4 py-6 border">
          <div className="flex flex-col gap-4">
            ...
            <p>
              Welcome to HASHTEL. By accessing or using our website, you agree
          ...
          <div className="flex flex-col gap-4">
            <h4>
              <strong>Product Pricing & Availability</strong>
            </h4>
            <ul className="list-disc list-outside pl-8">
              <li>Prices are subject to change without notice.</li>
              <li>
                We strive to maintain accurate stock information, but product
                availability is not guaranteed.
              </li>
              <li>
                We reserve the right to cancel any order if the price was
                incorrectly listed.
              </li>
            </ul>
          </div>
          <div className="flex flex-col gap-4">
            ...
            <ul className="list-disc list-outside pl-8">
              <li>
                Products can be replaced within 7 days if found defective upon
                delivery.
              </li>
              <li>
                Refunds are processed only if the product is unavailable for
                replacement.
              </li>
              <li>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="list-disc list-outside pl-8">
              ...
              <li>
                We are not responsible for incorrect addresses provided during
                checkout.
              </li>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p>
              Any disputes will be resolved through arbitration before resorting
              to legal action.
            </p>
          </div>
          <div className="flex flex-col gap-4">
