 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query FilteredProductItemList($channel: String!, $slugs: [ID!], $gte: Float, $lte: Float, $sortBy: OrderDirection!, $after: String, $search: String, $first: Int = 10) {\n  products(\n    first: $first\n    channel: $channel\n    filter: {categories: $slugs, price: {gte: $gte, lte: $lte}}\n    search: $search\n    sortBy: {direction: $sortBy, field: NAME}\n    after: $after\n  ) {\n    edges {\n      node {\n        ...ProductListItem\n      }\n    }\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n  }\n}"): typeof import('./graphql').FilteredProductItemListDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
